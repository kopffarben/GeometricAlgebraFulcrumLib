...
[TestFixture]
public sealed class ScalarSmoothStepSignalEquivalenceTests
{
    private const double Tolerance = 1e-10; // Slightly relaxed tolerance for transcendental functions
    private static readonly ScalarProcessorOfFloat64 ScalarProcessor = ScalarProcessorOfFloat64.Instance;

    [Test]
    public void TestFiniteSmoothStepSignal_BoundaryValues()
    {
        var float64Signal = Float64ScalarSmoothStepSignal.FiniteInstance;
        var genericSignal = ScalarSmoothStepSignal<double>.Finite(ScalarProcessor);
        ...
        // Test at t = 0 (midpoint, should be 0)
        var t2 = 0.0;
    ...
    [Test]
    public void TestFiniteSmoothStepSignal_NegativeRegion()
    {
        var float64Signal = Float64ScalarSmoothStepSignal.FiniteInstance;
        var genericSignal = ScalarSmoothStepSignal<double>.Finite(ScalarProcessor);
    ...
    [Test]
    public void TestFiniteSmoothStepSignal_PositiveRegion()
    {
        var float64Signal = Float64ScalarSmoothStepSignal.FiniteInstance;
        var genericSignal = ScalarSmoothStepSignal<double>.Finite(ScalarProcessor);
    ...
    [Test]
    public void TestFiniteSmoothStepSignal_MonotonicallyIncreasing()
    {
        var genericSignal = ScalarSmoothStepSignal<double>.Finite(ScalarProcessor);
    ...
    [Test]
    public void TestFiniteSmoothStepSignal_Derivative1()
    {
        var float64Signal = Float64ScalarSmoothStepSignal.FiniteInstance;
        var genericSignal = ScalarSmoothStepSignal<double>.Finite(ScalarProcessor);
    ...
    [Test]
    public void TestFiniteSmoothStepSignal_Derivative1AtBoundaries()
    {
        var float64Signal = Float64ScalarSmoothStepSignal.FiniteInstance;
        var genericSignal = ScalarSmoothStepSignal<double>.Finite(ScalarProcessor);
    ...
    [Test]
    public void TestFiniteSmoothStepSignal_Derivative2()
    {
        var float64Signal = Float64ScalarSmoothStepSignal.FiniteInstance;
        var genericSignal = ScalarSmoothStepSignal<double>.Finite(ScalarProcessor);
    ...
    [Test]
    public void TestPeriodicSmoothStepSignal()
    {
        var float64Signal = Float64ScalarSmoothStepSignal.PeriodicInstance;
        var genericSignal = ScalarSmoothStepSignal<double>.Periodic(ScalarProcessor);
    ...
    {
        var finiteSignal = ScalarSmoothStepSignal<double>.Finite(ScalarProcessor);
        var periodicSignal = finiteSignal.ToPeriodicSignal() as ScalarSmoothStepSignal<double>;
    ...
    {
        var periodicSignal = ScalarSmoothStepSignal<double>.Periodic(ScalarProcessor);
        var finiteSignal = periodicSignal.ToFiniteSignal() as ScalarSmoothStepSignal<double>;
    ...
    {
        var signal = ScalarSmoothStepSignal<double>.Finite(ScalarProcessor);
