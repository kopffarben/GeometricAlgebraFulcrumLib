...
[TestFixture]
public class CosScalarSignalEquivalenceTests
{
    ...
    [Test]
    public void CosSignal_Finite_GetValue_AtZero_ShouldMatchFloat64()
    {
        var signalFloat64 = Float64ScalarCosSignal.Finite();
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
        ...
        Assert.That(valueGeneric.ScalarValue, Is.EqualTo(valueFloat64).Within(Tolerance),
            $"cos(0) should be 1. Float64: {valueFloat64}, Generic: {valueGeneric.ScalarValue}");
    }

    [Test]
    public void CosSignal_Finite_GetValue_AtPiOverTwo_ShouldMatchFloat64()
    {
        var signalFloat64 = Float64ScalarCosSignal.Finite();
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
        ...
        Assert.That(valueGeneric.ScalarValue, Is.EqualTo(valueFloat64).Within(Tolerance),
            $"cos(π/2) should be ~0. Float64: {valueFloat64}, Generic: {valueGeneric.ScalarValue}");
    }

    [Test]
    public void CosSignal_Finite_GetValue_AtPi_ShouldMatchFloat64()
    {
        var signalFloat64 = Float64ScalarCosSignal.Finite();
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
        ...
        Assert.That(valueGeneric.ScalarValue, Is.EqualTo(valueFloat64).Within(Tolerance),
            $"cos(π) should be -1. Float64: {valueFloat64}, Generic: {valueGeneric.ScalarValue}");
    }

    [Test]
    public void CosSignal_Finite_GetValue_AtMinusPi_ShouldMatchFloat64()
    {
        var signalFloat64 = Float64ScalarCosSignal.Finite();
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
    ...
    [Test]
    public void CosSignal_Periodic_GetValue_AtZero_ShouldMatchFloat64()
    {
        var signalFloat64 = Float64ScalarCosSignal.Periodic();
        var signalGeneric = CosScalarSignal<double>.Periodic(ScalarProcessor);
    ...
    [Test]
    public void CosSignal_GetDerivative1Value_AtZero_ShouldMatchFloat64()
    {
        var signalFloat64 = Float64ScalarCosSignal.Finite();
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
        ...
        Assert.That(deriv1Generic.ScalarValue, Is.EqualTo(deriv1Float64).Within(Tolerance),
            $"cos'(0) = -sin(0) should be 0. Float64: {deriv1Float64}, Generic: {deriv1Generic.ScalarValue}");
    }

    [Test]
    public void CosSignal_GetDerivative1Value_AtPiOverTwo_ShouldMatchFloat64()
    {
        var signalFloat64 = Float64ScalarCosSignal.Finite();
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
        ...
        Assert.That(deriv1Generic.ScalarValue, Is.EqualTo(deriv1Float64).Within(Tolerance),
            $"cos'(π/2) = -sin(π/2) should be -1. Float64: {deriv1Float64}, Generic: {deriv1Generic.ScalarValue}");
    }

    [Test]
    public void CosSignal_GetDerivative2Value_AtZero_ShouldMatchFloat64()
    {
        var signalFloat64 = Float64ScalarCosSignal.Finite();
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
        ...
        Assert.That(deriv2Generic.ScalarValue, Is.EqualTo(deriv2Float64).Within(Tolerance),
            $"cos''(0) = -cos(0) should be -1. Float64: {deriv2Float64}, Generic: {deriv2Generic.ScalarValue}");
    }

    [Test]
    public void CosSignal_GetDerivative2Value_AtPi_ShouldMatchFloat64()
    {
        var signalFloat64 = Float64ScalarCosSignal.Finite();
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
        ...
        Assert.That(deriv2Generic.ScalarValue, Is.EqualTo(deriv2Float64).Within(Tolerance),
            $"cos''(π) = -cos(π) should be 1. Float64: {deriv2Float64}, Generic: {deriv2Generic.ScalarValue}");
    }

    [Test]
    public void CosSignal_ToFiniteSignal_ShouldReturnFiniteInstance()
    {
        var signalGeneric = CosScalarSignal<double>.Periodic(ScalarProcessor);
    ...
    [Test]
    public void CosSignal_ToPeriodicSignal_ShouldReturnPeriodicInstance()
    {
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
    ...
    [Test]
    public void CosSignal_IsValid_ShouldReturnTrue()
    {
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
    ...
    [Test]
    public void CosSignal_TimeRange_ShouldBeSymmetricPi()
    {
        var signalGeneric = CosScalarSignal<double>.Finite(ScalarProcessor);
