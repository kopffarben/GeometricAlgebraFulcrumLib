...
public static class CatmullRomUtils
{
    ...
    /// <summary>
    /// Compute Catmull-Rom spline value for LinVector2D.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinVector2D<T> GetCatmullRomValue<T>(this Scalar<T> t, Quad<Scalar<T>> tQuad, Quad<LinVector2D<T>> pQuad)
    {
        var (t0, t1, t2, t3) = tQuad;
        var (p0, p1, p2, p3) = pQuad;
    ...
    /// <summary>
    /// Compute first derivative of Catmull-Rom spline for LinVector2D.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinVector2D<T> GetCatmullRomDerivativeValue<T>(this Scalar<T> t, Quad<Scalar<T>> tQuad, Quad<LinVector2D<T>> pQuad)
    {
        var (t0, t1, t2, t3) = tQuad;
        var (p0, p1, p2, p3) = pQuad;
    ...
    /// <summary>
    /// Compute second derivative of Catmull-Rom spline for LinVector2D.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinVector2D<T> GetCatmullRomDerivative2Value<T>(this Scalar<T> t, Quad<Scalar<T>> tQuad, Quad<LinVector2D<T>> pQuad)
    {
        var (t0, t1, t2, t3) = tQuad;
        var (p0, p1, p2, p3) = pQuad;
        var processor = t.ScalarProcessor;
