...
/// <summary>
/// A cubic Bezier curve in 2D space (degree 3) defined by 4 control points
...
public sealed class Bezier3Path2D<T> :
    ParametricPath2D<T>
{
    public static Bezier3Path2D<T> Create(IScalarProcessor<T> scalarProcessor, bool isPeriodic, LinVector2D<T> point1, LinVector2D<T> point2, LinVector2D<T> point3, LinVector2D<T> point4)
    {
        ...
        return new Bezier3Path2D<T>(timeRange, isPeriodic, point1, point2, point3, point4);
    }

    public static Bezier3Path2D<T> Create(ScalarRange<T> timeRange, bool isPeriodic, LinVector2D<T> point1, LinVector2D<T> point2, LinVector2D<T> point3, LinVector2D<T> point4)
    {
        return new Bezier3Path2D<T>(timeRange, isPeriodic, point1, point2, point3, point4);
    }
    ...
    public LinVector2D<T> Point4 { get; }


    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private Bezier3Path2D(ScalarRange<T> timeRange, bool isPeriodic, LinVector2D<T> point1, LinVector2D<T> point2, LinVector2D<T> point3, LinVector2D<T> point4)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Bezier2Path2D<T> GetDerivativeCurve()
    {
    ...
    public override ParametricPath2D<T> ToFinitePath()
    {
        return IsFinite
            ? this
            : new Bezier3Path2D<T>(TimeRange, false, Point1, Point2, Point3, Point4);
    }
    ...
    public override ParametricPath2D<T> ToPeriodicPath()
    {
        return IsPeriodic
            ? this
            : new Bezier3Path2D<T>(TimeRange, true, Point1, Point2, Point3, Point4);
    }
