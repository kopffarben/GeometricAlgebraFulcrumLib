...
/// <summary>
/// A parametric 3D curve with generic scalar type T for time parameterization
/// </summary>
...
/// </remarks>
public abstract class ParametricPath3D<T>(ScalarRange<T> timeRange, bool isPeriodic) :
    Trajectory<T, LinVector3D<T>>(timeRange, isPeriodic)
{
    public abstract ParametricPath3D<T> ToFinitePath();

    public abstract ParametricPath3D<T> ToPeriodicPath();
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public abstract LinVector3D<T> GetDerivative1Value(Scalar<T> t);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public abstract LinVector3D<T> GetDerivative2Value(Scalar<T> t);

    /// <summary>
    /// Get the local frame (position, tangent, normal, binormal) at time t
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public virtual ParametricPath3DLocalFrame<T> GetFrame(Scalar<T> t)
    {
