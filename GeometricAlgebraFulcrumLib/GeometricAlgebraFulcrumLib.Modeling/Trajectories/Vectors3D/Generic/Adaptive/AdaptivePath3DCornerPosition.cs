...
/// <summary>
/// Represents a corner position in an adaptive sampling tree using hierarchical indexing.
/// Uses level and segment count to uniquely identify positions in the tree.
/// </summary>
public sealed record AdaptivePath3DCornerPosition :
    IComparable<AdaptivePath3DCornerPosition>
{
    ...
    public AdaptivePath3DCornerPosition(int level, int segmentCount)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CompareTo(AdaptivePath3DCornerPosition? other)
    {
        if (other is null)
